...
<div class="alert alert-dismissible rounded-0 py-3 px-0 m-0 fade show">
  <div class="container position-relative d-flex min-w-0">
    <div class="d-flex flex-nowrap align-items-center g-2 w-100 min-w-0 mx-auto mt-n1" style="max-width: 458px">
      ...
      <div class="swiper fs-sm" data-swiper='{
            "spaceBetween": 24,
            "loop": true,
            "autoplay": {
              "delay": 5000,
...
<header class="navbar-sticky sticky-top container z-fixed px-2" data-sticky-element>
  <div class="navbar navbar-expand-lg flex-nowrap bg-body rounded-pill shadow ps-0 mx-1">
      ...
      <div class="offcanvas-body pt-3 pb-4 py-lg-0 mx-lg-auto">
        <ul class="navbar-nav position-relative">
          <li class="nav-item me-lg-n1 me-xl-0">
            <a class="nav-link fs-sm @if(\Illuminate\Support\Facades\Request::url() == url('/')) active @endif"
              href="/">主页</a>
          </li>
          <li class="nav-item dropdown me-lg-n1 me-xl-0">
            <a class="nav-link dropdown-toggle fs-sm" role="button" data-bs-toggle="dropdown" data-bs-trigger="hover"
              data-bs-auto-close="outside" aria-expanded="false">联系客服</a>
            <ul class="dropdown-menu" style="--cz-dropdown-spacer: 1rem">
              <li><a class="dropdown-item" href="https://t.me/Gemini_51xueAi" target="_blank">TG人工客服</a></li>
              <li><a class="dropdown-item" href="https://t.me/ai51xue" target="_blank">加入补货通知频道</a></li>
            </ul>
          </li>
          <li class="nav-item me-lg-n2 me-xl-0">
            <a class="nav-link fs-sm" href="#modalId" style="font-size: 0.625rem; letter-spacing: 0.05rem"
              data-bs-toggle="modal" data-bs-target="#modalId">站点公告</a>
          </li>
          <li class="nav-item me-lg-n2 me-xl-0">
            <a class="nav-link fs-sm @if(\Illuminate\Support\Facades\Request::url() == url('order-search')) active @endif"
              href="/order-search">订单查询</a>
          </li>
          @guest
            <li class="nav-item me-lg-n2 me-xl-0">
              <a class="nav-link fs-sm" href="{{ route('login') }}">登录</a>
            </li>
            <li class="nav-item me-lg-n2 me-xl-0">
              <a class="nav-link fs-sm" href="{{ route('register') }}">注册</a>
            </li>
          @else
            <li class="nav-item dropdown me-lg-n1 me-xl-0">
              <a class="nav-link dropdown-toggle fs-sm" role="button" data-bs-toggle="dropdown" data-bs-trigger="hover"
                data-bs-auto-close="outside" aria-expanded="false">{{ Auth::user()->name }}</a>
              <ul class="dropdown-menu" style="--cz-dropdown-spacer: 1rem">
                <li>
    ...
    <div class="d-flex gap-sm-1 position-relative z-1">
      ...
      <!-- Search -->
      <a class="btn btn-icon fs-lg btn-outline-secondary border-0 rounded-circle animate-scale me-2"
        href="/order-search">
  ...
  <a class="btn-scroll-top btn btn-sm bg-body border-0 rounded-pill shadow animate-slide-end" href="#top">
    ...
    <svg class="position-absolute top-0 start-0 w-100 h-100 z-1" viewBox="0 0 62 32" fill="none"
      ...
      <rect x=".75" y=".75" width="60.5" height="30.5" rx="15.25" stroke="currentColor" stroke-width="1.5"
        stroke-miterlimit="10" style="stroke-dasharray: 155.201; stroke-dashoffset: 0"></rect>
    </svg>
  </a>
</div>
<!-- 公告 -->

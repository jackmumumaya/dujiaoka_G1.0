        ...
        <div class="card shadow-sm">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    <h4 class="fw-bold">{{ __('dujiaoka.login') ?? '登录' }}</h4>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('email') is-invalid @enderror" type="email" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="输入您的邮箱">
                        @error('email')
                ...
                <div class="text-center mt-3">
                    <p class="text-muted">还没有账号？ <a href="{{ route('register') }}" class="text-primary"><b>注册</b></a></p>
                </div>

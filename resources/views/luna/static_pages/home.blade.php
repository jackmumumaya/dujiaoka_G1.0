            ...
            <div class="layui-row">
                <div class="layui-col-md8 layui-col-md-offset2 layui-col-sm12">
                    <div class="main-box">
                        ...
                        <div class="filter-box" style="padding: 10px 20px; text-align: center;">
                            <div class="layui-btn-group">
                                <a href="{{ request()->fullUrlWithQuery(['sort' => null]) }}"
                                    class="layui-btn layui-btn-sm {{ !request('sort') ? 'layui-btn-normal' : 'layui-btn-primary' }}">
                                    {{ __('dujiaoka.default_sort') }}
                                </a>
                                <a href="{{ request()->fullUrlWithQuery(['sort' => 'sales_volume']) }}"
                                    class="layui-btn layui-btn-sm {{ request('sort') == 'sales_volume' ? 'layui-btn-normal' : 'layui-btn-primary' }}">
                                    {{ __('dujiaoka.sales_volume') }}
                                </a>
                                <a href="{{ request()->fullUrlWithQuery(['filter' => request('filter') == 'in_stock' ? null : 'in_stock']) }}"
                                    class="layui-btn layui-btn-sm {{ request('filter') == 'in_stock' ? 'layui-btn-normal' : 'layui-btn-primary' }}">

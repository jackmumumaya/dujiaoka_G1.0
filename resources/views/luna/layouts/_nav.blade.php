                ...
                <div class="query layui-hide-xs" style="margin-left: 10px;">
                    ...
                    @else
                        ...
                        <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                            @csrf
                            <button type="submit"
                                style="background: none; border: none; color: #fff; cursor: pointer; margin-left: 5px; text-decoration: underline;">退出</button>
                        </form>
                    @endguest
                </div>
                @yield('notice')
